...
abstract class ContentBase
{
	...
	protected function SetProperties()
	{
		...
		$this->AddProperty('alias',3,self::TAB_NAV);
		$this->AddProperty('page_url',4,self::TAB_NAV);
		$this->AddProperty('showinmenu',5,self::TAB_NAV);
		$this->AddProperty('titleattribute',6,self::TAB_NAV);
		// $this->AddProperty('accesskey',7,self::TAB_NAV);
		// $this->AddProperty('tabindex',8,self::TAB_NAV);
		$this->AddProperty('target',9,self::TAB_NAV);
