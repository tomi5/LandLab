...
$lang['back'] = 'Назад';
$lang['ahead'] = 'Вперед';
$lang['info_mass_adjust_articles'] = 'Эта форма позволяет корректировать даты на странице вперед или назад на указанный интервал. Допускается максимум 5 лет или 60 единиц.';
$lang['title_mass_adjust_articles'] = 'Массовая настройка времени работы';
$lang['adjust_times'] = 'Изменить время';
$lang['info_reorder_categories'] = 'Вы можете реорганизовать список категорий, перетащив категории в новый порядок. Соблюдайте осторожность, поскольку реорганизация категорий может вызвать проблемы с отображением категорий на интерфейсе сайта';
$lang['reorder_categories'] = 'Упорядочить категории';
$lang['error_deleteparent'] = 'Родительская категория не может быть удалена';
$lang['category_parent'] = 'родитель';
$lang['category_description'] = 'Описание';
$lang['search'] = 'Поиск';
$lang['search_text'] = 'Поиск текста';
$lang['info_search'] = 'Это выполняет поиск подстроки по заголовку статьи и содержимому для принадлежащих вам статей. Необходимо ввести не менее трех символов';
$lang['err_nothingselected'] = 'Ничего не выбрано';
$lang['msg_bulk_successful'] = 'Успешная операция';
$lang['with_selected'] = 'С выбранными:';
$lang['fesubmit_email_status'] = 'Отправить письмо, если статус статьи';
$lang['any'] = 'Любые';
$lang['legend_fesubmit_notification'] = 'Уведомления';
$lang['title_needs_approval'] = 'Эта статья ожидает рассмотрения';
$lang['review'] = 'Обзор';
$lang['info_filter_title'] = 'Введите заголовок';
$lang['info_filter_author'] = 'Введите автора';
$lang['reset'] = 'Сброс';
$lang['really_uninstall'] = 'Вы действительно хотите удалить этот модуль? Все данные, связанные с этим модулем, будут окончательно удалены из базы данных.';
$lang['error_getarticle'] = 'Возникла проблема с получением статьи';
$lang['toggle_filter'] = 'Фильтр...';
$lang['notice'] = 'Уведомление';
$lang['detail_page'] = 'Подробная страница';
$lang['detail_template'] = 'Подробный шаблон';
$lang['tab_preview'] = 'Предварительный просмотр';
$lang['article'] = 'Статья';
$lang['title_default_showall'] = 'Показать все статьи';
$lang['title_default_pagelimit'] = 'Количество на одной странице по умолчанию';
$lang['sortorder_desc'] = 'Нисходящий';
$lang['sortorder_asc'] = 'Восходящий';
$lang['sortby_starttime'] = 'Дата начала статьи';
$lang['sortby_endtime'] = 'Дата окончания статьи';
$lang['sortby_random'] = 'Случайная сортировка';
$lang['sortby_extra'] = 'Дополнительное поле статьи';
$lang['sortby_summary'] = 'Обзор статьи';
$lang['sortby_category'] = 'Категория статьи';
$lang['sortby_title'] = 'Название статьи';
$lang['sortby_date'] = 'Дата статьи';
$lang['title_default_sortby'] = 'Сортировка по умолчанию';
$lang['title_default_sortorder'] = 'Сортировка по умолчанию';
$lang['summary_options'] = 'Суммарные параметры просмотра';
$lang['prompt_friendlyname'] = 'Дружественное имя для этого модуля';
$lang['url_template'] = 'Шаблон URL';
$lang['error_urlused'] = 'Указанный URL уже используется';
$lang['error_badurl'] = 'Указанный URL недействителен';
$lang['info_fesubmit_wysiwyg'] = 'Эта опция отключила использование wysiwyg во всех областях формы подачи внешнего интерфейса, независимо от других настроек';
$lang['fesubmit_wysiwyg'] = 'Разрешить использование редактора wysiwyg';
$lang['return_to_content'] = 'Назад';
$lang['size'] = 'Размер';
$lang['allowed_filetypes'] = 'Допустимые типы файлов';
$lang['enable_wysiwyg'] = 'Включить Wysiwyg';
$lang['preview_size'] = 'Предварительный размер изображения (в пикселях)';
$lang['preview'] = 'Создать изображение предварительного просмотра';
$lang['watermark'] = 'Водяной знак на загруженное изображение';
$lang['allowed_imagetypes'] = 'Типы разрешенных изображений';
$lang['image'] = 'Изображение';
$lang['my_articles'] = 'Мои статьи';
$lang['id'] = 'id';
$lang['modified'] = 'Изменено';
$lang['fesubmit_managearticles'] = 'Разрешить Frontend пользователям управлять своими собственными блогами?';
$lang['url'] = 'URL';
$lang['addedit_archive_template'] = 'Добавить / изменить шаблон просмотра архива';
$lang['info_archive_templates'] = 'Доступные шаблоны просмотра архива';
$lang['archivetemplate'] = 'Шаблоны архива';
$lang['title_sysdefault_archive_template'] = 'Шаблон архива по умолчанию';
$lang['category_modified'] = 'Категория успешно отредактирована';
$lang['category_name'] = 'Название категории';
$lang['edit_category'] = 'Изменить категорию';
$lang['error_nocatname'] = 'Без названия категории';
$lang['move_up'] = 'Переместить это наверх';
$lang['move_down'] = 'Переместить это вниз';
$lang['postuninstall'] = 'Модуль CGBlog удален. Теперь можно безопасно удалять файлы, связанные с этим модулем';
...
$lang['templaterestored'] = 'Восстановленный шаблон';
$lang['fesubmit_status'] = 'Статус новостей представленных через интерфейс';
$lang['fesubmit_email_users'] = 'Отправить уведомление (по электронной почте) этим пользователям';
$lang['no'] = 'Нет';
$lang['yes'] = 'ДА';
$lang['fesubmit_email_template'] = 'Шаблон электронной почты';
$lang['fesubmit_email_html'] = 'Отправлять HTML письмо?';
$lang['fesubmit_email_subject'] = 'Тема письма';
$lang['general_options'] = 'Общие параметры блога';
$lang['category_added'] = 'Добавлена категория';
$lang['category_name_exists'] = 'Категория с таким именем уже существует';
$lang['add_category'] = 'Добавить категорию';
$lang['addedit_summary_template'] = 'Добавить / изменить суммарный шаблон';
$lang['addedit_detail_template'] = 'Добавить / изменить подробный шаблон';
$lang['addedit_browsecat_template'] = 'Добавить / изменить шаблон категории';
$lang['info_summary_templates'] = 'Доступные суммарные шаблоны';
$lang['info_detail_templates'] = 'Доступные  подробные шаблоны';
$lang['info_browsecat_templates'] = 'Доступные шаблонов категорий';
$lang['title_sysdefault_browsecat_template'] = 'Шаблон категорий по умолчанию';
$lang['title_sysdefault_detail_template'] = 'Шаблон подробного просмотра по умолчанию';
$lang['title_sysdefault_summary_template'] = 'Суммарный шаблон по умолчанию';
...
$lang['articleaddeddraft'] = 'Запись была успешно добавлена. Администратор просмотрит вашу запись и, если одобрит, опубликует статью.';
