...
$lang['field_type_HTML5NumberField'] = 'Entrada de n&uacute;mero HTML5';
...
$lang['field_type_DispositionUniqueFile'] = '*Guardar resultados a un &uacute;nico archivo plano por cada env&iacute;o';
...
$lang['field_type_DispositionForm'] = '*Enviar a una acci&oacute;n de formulario arbitraria';
...
$lang['field_type_CompanyDirectoryField'] = 'Campo Directorio de la Compa&ntilde;&iacute;a';
$lang['field_type_ModuleInterfaceField'] = '-Campo de Interfaz de M&oacute;dulo';
...
$lang['error_emailfromfeuprop'] = 'Error en configuraci&oacute;n de Campo';
$lang['error_nofeu'] = 'No se pudo encontrar el m&oacute;dulo FrontEndUseres. Este campo no funcionar&aacute;';
$lang['error_nofeudefns'] = 'No se encontr&oacute; ninguna propiedad FEU. Este campo no tendr&aacute; ninguna funci&oacute;n';
...
$lang['please_login'] = 'Por favor inicie sesi&oacute;n para utilizar este formulario';
...
$lang['title_allow_overwrite'] = '&iquest;Permitir la sobreescritura de archivos previos al subir?';
$lang['title_allow_overwrite_long'] = 'El archivo subido deber&iacute;a reemplazar el archivo anterior si tienen el mismo nombre?';
...
$lang['file_rename_help'] = 'Para renombrar los archivos al subir, crear la plantilla aqu&iacute;. Deje en blanco para preservar el nombre de archivo original.';
...
$lang['title_data_stored_in_fbr'] = 'Los datos ser&aacute;n almacenados en la tabla [PREFIX]_module_fb_formbrowser de la base de datos.';
$lang['error_has_no_fb_field'] = '&iexcl;Error! El formulario no tiene campo de disposici&oacute;n para Form Browser, o &eacute;ste fall&oacute; en instanciarse (&iquest;debido a problemas de memoria?)';
$lang['help_date_order'] = 'Use &quot;m&quot; para Mes, &quot;d&quot; para D&iacute;a, y &quot;y&quot; para A&ntilde;o. Separe los elementos con guiones.';
...
$lang['help_ignored_if_upload'] = '(este campo se ignora si usa el m&oacute;dulo Uploads para manejar los archivos)';
...
Este campo ser&aacute; ignorado si usa TXT como tipo de archivo.';
...
$lang['title_file_footer'] = 'Plantilla del pi&eacute; del archivo de salida';
...
$lang['email_from_addr_help'] = 'No utilice cualquier direcci&oacute;n al azar -- Muchos ISP<br /> no enviaran el email si utiliza un dominio diferente a su verdadero <br />nombre de host (ej. use algo como nombre@%s)';
...
Tambi&eacute;n verifique que no tiene restricciones en el directorio PHP.';
...
$lang['title_allow_subject_override'] = '&iquest;Permitir que el asunto sea sobreescrito?';
...
$lang['title_minimum_length'] = 'M&iacute;nima longitud de respuesta';
$lang['title_hide'] = 'Esconder entrada';
$lang['title_hide_help'] = 'Utilizar s&iacute;mbolos en vez de texto plano cuando el usuario introduce su password?';
$lang['password_does_not_match'] = 'Los password no coinciden %s';
$lang['back_top'] = 'Volver a la P&aacute;gina Principal de FormBuilder';
$lang['title_headers_to_modify'] = '&iquest;Cuales encabezados de email deber&iacute;a de poblar este campo?';
$lang['title_blank_invalid'] = 'No aceptar espacio en blanco como respuesta v&aacute;lida';
$lang['title_blank_invalid_long'] = 'Si un campo es requerido, Marcar esto requerir&aacute; que los usuarios pongan caracteres alfanum&eacute;ricos y no solamente espacios.';
$lang['title_must_save_order'] = 'You must click one of the &quot;save&quot; buttons to make your new field order permanent.';
$lang['title_html5'] = 'Utilizar marcador de posici&oacute;n (placeholder) HTML5 en lugar de Javascript';
...
$lang['title_year_end_message'] = 'A&ntilde;o Final';
...
$lang['operators_help'] = 'Si usted utiliza evaluaci&oacute;n de String, la &uacute;nica operaci&oacute;n disponible es concatenaci&oacute;n (+), mientras que si usa evaluaci&oacute;n num&eacute;rica usted tiene c&aacute;lculos matem&aacute;ticos b&aacute;sicos y muy simples (, +, -, *, /, ). Si utliza evaluaci&oacute;n Computada/PHP, puede utilizar cualquier funci&oacute;n pero necesita entrecomillar las cosas (hay substituci&oacute;n antes de la evaluaci&oacute;n, por ej. substr(&#039;$fld_22&#039;,0,2).&#039;$fld_23&#039;.';
